...
- Female data subset:
  ...
  - Best class: Obesity (0.78)
  - Worst class: Normal Weight (0.32)
  - Common confusion: Obesity ↔ Overweight (21/96 cases)


- Male data subset:

  - Average F1-score: 0,4975
  - Best class: Obesity (0.66)
  - Worst class: Insufficient Weight (0.40)
  - Common confusion: Overweight ↔ Obesity (26/67 cases)
